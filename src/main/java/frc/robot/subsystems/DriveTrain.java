...
public class DriveTrain extends SubsystemBase {
  ...
  // private static MotorController frontLeftVictorSPX = new
  // VictorSPXMecanum(Constants.MOTOR_FRONT_LEFT);
  // private static MotorController frontRightVictorSPX = new
  // VictorSPXMecanum(Constants.MOTOR_FRONT_RIGHT);
  // private static MotorController backLeftVictorSPX = new
  // VictorSPXMecanum(Constants.MOTOR_BACK_LEFT);
  // private static MotorController backRightVictorSPX = new
  // VictorSPXMecanum(Constants.MOTOR_BACK_RIGHT);
  ...
  // private static MecanumWrapperClass chassisDrive = new
  // MecanumWrapperClass(frontLeftVictorSPX, backLeftVictorSPX,
  // frontRightVictorSPX, backRightVictorSPX);
  ...
  private static int[] motorPolarity = { Constants.FRONT_LEFT_POLARITY, Constants.FRONT_RIGHT_POLARITY,
